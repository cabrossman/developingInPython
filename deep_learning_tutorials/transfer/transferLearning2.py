...
from the earlier layer and train a classifier on top of that. This requires a little bit of knowledge on h5py.
"""
...
from tensorflow.keras.layers import Dropout, Flatten, Dense, GlobalAveragePooling2D, Input, Conv2D, MaxPooling2D
...
import h5py
import os
os.chdir('C:\\Users\\chrisb\\OneDrive - Leesa\\jobs\\deep_learning_tutorials\\')
